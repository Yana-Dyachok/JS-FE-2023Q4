...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, `button:not(.message__delete):not(.message__edit) {
  border-radius: 1rem;
  cursor: pointer;
}
button:not(.message__delete):not(.message__edit):disabled {
  border: none;
  background-color: #bdd1c5;
  box-shadow: none;
  cursor: not-allowed;
...
@media (hover: hover) and (pointer: fine) and (pointer: fine) {
  button:not(.message__delete):not(.message__edit):hover:not([disabled]) {
    color: #f3dcdc;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getRequestDeliverMessage = exports.getRequestEditMessage = exports.getRequestServerOneMessage = exports.getRequestOneMessage = exports.getRequestHistoryMessage = exports.getRequestSendMessage = exports.getUsersRequest = exports.getExternalRequest = exports.getRequest = void 0;
...
const getRequestOneMessage = (id, messageType, idMs) => ({
    id,
    type: messageType,
    payload: {
        message: {
...
exports.getRequestOneMessage = getRequestOneMessage;
const getRequestServerOneMessage = (messageType, idMs) => ({
    id: null,
    type: messageType,
    payload: {
        message: {
...
exports.getRequestServerOneMessage = getRequestServerOneMessage;
const getRequestEditMessage = (id, messageType, idMs, textEdited) => ({
    id,
    type: messageType,
    payload: {
        message: {
...
exports.getRequestEditMessage = getRequestEditMessage;
const getRequestDeliverMessage = (messageType, idMs, status) => ({
    id: null,
    type: messageType,
    payload: {
        message: {
...
exports.getRequestDeliverMessage = getRequestDeliverMessage;
...
class Websocket {
        ...
        this.onMessage = (e) => {
            ...
            switch (response.type) {
                ...
                case enum_1.MessageType.delete_msg: {
                    const { payload } = response;
                    const { message } = payload;
                    state_1.state.setDeletedMessage(message.id);
                    break;
                }
    ...
    initListeners() {
        ...
        this.socket.addEventListener("open", (error) => {
            popup_1.popup.deletePopup();
        });
        this.socket.addEventListener("close", (error) => {
            popup_1.popup.createPopupElements("Сonnection to the server");
        });
    }
    ...
    getReadMessage(idMs) {
        const id = Date.now().toString();
        this.socket.send(JSON.stringify((0, request_1.getRequestOneMessage)(id, enum_1.MessageType.msg_read, idMs)));
    }
    deleteMessage(idMs) {
        const id = Date.now().toString();
        this.socket.send(JSON.stringify((0, request_1.getRequestOneMessage)(id, enum_1.MessageType.delete_msg, idMs)));
    }
    deleteServerMessage(idMs) {
        this.socket.send(JSON.stringify((0, request_1.getRequestServerOneMessage)(enum_1.MessageType.delete_msg, idMs)));
    }
    editMessage(idMs, text) {
        const id = Date.now().toString();
        this.socket.send(JSON.stringify((0, request_1.getRequestEditMessage)(id, enum_1.MessageType.edit_msg, idMs, text)));
    }
}
...
class Content {
    ...
    getFilterMessage(user) {
        ...
        /* eslint-disable */ console.log(...oo_oo(`2019744248_85_4_85_29_4`, sentMessages));
    }
    createAllUsers() {
    ...
    updateMessageBlock() {
        ...
        const idArray = [];
        idArray.push(...state_1.state.getDeletedMessage());
        const messages = uniqueMessages
            .filter((message) => (message.from === this.userLogin || message.to === this.userLogin) &&
            !idArray.includes(message.id))
            .map((message) => create_message_block_1.messageBlock.createMessageBlock(message));
...
const state_1 = __webpack_require__(/*! ../../../state/state */ "./src/state/state.ts");
const delete_btn_1 = __importDefault(__webpack_require__(/*! ../delete-btn/delete-btn */ "./src/core/components/delete-btn/delete-btn.ts"));
const edit_btn_1 = __importDefault(__webpack_require__(/*! ../edit-button/edit-btn */ "./src/core/components/edit-button/edit-btn.ts"));
    ...
    constructor() {
        this.createMessageBlock = (message) => {
            ...
            if (state_1.state.getUser().login === from) {
                ...
                this.deleteButton = new delete_btn_1.default();
                this.deleteButton.deleteMessage(id);
                this.editButton = new edit_btn_1.default();
...
exports.messageBlock = new MessageBlock();
...
/***/ "./src/core/components/delete-btn/delete-btn.ts":
/*!******************************************************!*\
  !*** ./src/core/components/delete-btn/delete-btn.ts ***!
  \******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const websocket_1 = __webpack_require__(/*! ../../../api/websocket */ "./src/api/websocket.ts");
class DeleteButton extends button_1.default {
    constructor() {
        super("message__delete-btn", "message__delete", "", "button");
    }
    deleteMessage(dataset) {
        const content = document.querySelector(".dialog__content");
        this.onClick(() => {
            if (dataset) {
                websocket_1.ws.deleteMessage(dataset);
                // ws.deleteServerMessage(dataset)
                const messageBlock = document.querySelector(`[data-message-block="${dataset}"]`);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.createButton = exports.createDiv = exports.createDialogInputForm = exports.createContentText = exports.createDialogContent = exports.createLabel = exports.createArticle = exports.createInputMessage = void 0;
...
/***/ "./src/core/components/edit-button/edit-btn.ts":
/*!*****************************************************!*\
  !*** ./src/core/components/edit-button/edit-btn.ts ***!
  \*****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const button_1 = __importDefault(__webpack_require__(/*! ../button/button */ "./src/core/components/button/button.ts"));
const websocket_1 = __webpack_require__(/*! ../../../api/websocket */ "./src/api/websocket.ts");
class EditButton extends button_1.default {
    constructor() {
    ...
    editMessage(dataset) {
        this.onClick(() => {
            if (dataset) {
                ...
                const edit = document.querySelector(`[data-message-edit="${dataset}"]`);
                if (messageText) {
                    ...
                    inputElement.addEventListener("keyup", (event) => {
                        if (event.key === "Enter" && inputElement.value.length > 0) {
                            ...
                            websocket_1.ws.editMessage(dataset, newText);
                            if (edit)

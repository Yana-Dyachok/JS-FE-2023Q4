...
class MainPage {
  ...
  constructor() {
    ...
    this.playField = new PlayField(
      this.btnsPlayField.continueBtn,
      this.btnsPlayField.checkBtn,
      this.btnsPlayField.autoCompleteBtn,
    );
  }
  ...
  drawMainPage = (): void => {
    ...
    if (container !== null) {
      ...
      container.append(
        this.playField.getRootElement(),
        this.btnsPlayField.getRootElement(),
      );
    }
  };
}

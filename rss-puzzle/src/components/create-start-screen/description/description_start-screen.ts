class DescriptionStartScreen {
    ...
    createDescriptionElements(): void {
        ...
        gameName.textContent = 'RSS Puzzle';
        this.description.append(gameName);
        const name = document.createElement('p');
        name.classList.add('start-screen_game-description');
        name.textContent =
            'Step into the world of RSS Puzzle, a captivating game designed to sharpen your English language skills, players piece together scrambled words to form meaningful sentences. With varying difficulty levels, helpful hints, and stunning artwork, RSS Puzzle offers an immersive and enjoyable experience for language enthusiasts of all levels.';
